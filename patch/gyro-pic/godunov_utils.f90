...
subroutine cmpdt(uu,gg,dx,dt,ncell)
  ...
  do k = 1,ncell
   ...
   if ((pic_dust.or.pic_cr).and..not.guiding_center) then
      ! if guiding_center is true, we ignore this block
     do k = 1, ncell
